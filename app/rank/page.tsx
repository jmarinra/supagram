      ...
      >
        ...
        <div className="flex items-center gap-3 p-4 border-b border-border">
          <div className="relative w-10 h-10 rounded-full overflow-hidden ring-2 ring-primary">
            <Image
              src={'https://fulxpmtvxjdkuprjtblk.supabase.co/storage/v1/object/public/supagram-bucket/profile/user.png'
              }
              alt=' '
              fill
        ...
        <div className="p-4">
          ...
          <p className="mt-2 text-foreground">
            <span className="font-semibold">{'Supagram'}</span>{" "}
    ...
    useEffect(() => {
      async function getPosts() {
       ...
       // .gt('likes', )
        ...
        if (error){
          new Error('Error en la consulta', error)
        } else {
          setPosts(posts)
          console.log(posts)
        }
